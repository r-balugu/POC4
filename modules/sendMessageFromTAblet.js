...
function sendMessageFromTablet(){
  ...
  var iParam = {"userid": "chandrasena.chittimalla@kony.com","password": "Cloudsena@1234"};
...
function getPushServiceCallBackCallback(res){
  ...
  var iParam = {"data": "LifeHacks for users have been updated","title": "LifeHacks Updates"};
  var header = {"X-Kony-Authorization":accessToken};
