...
function frmAdminGlobals() {
    frmAdmin = new kony.ui.Form2({
        ...
        "directChildrenIDs": ["btnAdmin", "btnManage", "btnSave", "flexAdmin", "flexContent", "flexFocus", "flexManage", "flexRefresh", "flexSubHeaders", "flxBody", "flxBody2", "flxBody3", "flxHeader", "flxMain", "flxScrollHamburger", "Image027244a45d4004a", "Image06bbac8803ccc47", "imgArrow", "imgLogo", "imgrefresh", "imgUserImage", "lblAvailable", "lblSelected", "lblSelectedUser", "lblUser", "segList", "segListLF", "segListUser", "segMenu"],
