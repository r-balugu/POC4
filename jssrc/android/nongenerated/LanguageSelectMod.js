function slideimgLogo() {
    ...
    frmSplash.imgSymTrac.animate(kony.ui.createAnimation({
        "100": {
            "centerY": "20%",
            "stepConfig": {
...
function slideimgNovatris() {
    frmSplash.imgNov.animate(kony.ui.createAnimation({
        "100": {
            "centerY": "50%",
            "stepConfig": {
                "timingFunction": kony.anim.EASE
...
function slideLanguageSelectFlex() {
    frmSplash.flxLanguageSelect.animate(kony.ui.createAnimation({
        "100": {
            "bottom": "0%",
            "stepConfig": {
                "timingFunction": kony.anim.EASE
