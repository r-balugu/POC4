...
function loadSymptomsData() {
    tabSymptomsData = [{
        "lblSymptoms": "Blind spots",
        "lblKey": 1
    }, {
        "lblSymptoms": "Colour Blindness",
        "lblKey": 2
    }, {
        "lblSymptoms": "Fatigue",
        "lblKey": 3
    }, {
        "lblSymptoms": "Hearing Problems",
        "lblKey": 4
    }, {
        "lblSymptoms": "Insomnia",
        "lblKey": 5
    }];
}
/**
...
function saveNewSymptom() {
    ...
    tempNewSymptom = {
        "symptom": slctdSymptomsList,
        "sliderImpactFeel": sliderImpactFeelValue,
        "sliderImpactActivities": sliderImpactDailyActivitiesValue,
        "bodyPlaceSelected": bodyPlaceSelected,
        "comments": notesText
    };
...
function onClickSave_frmDailyTracker() {
    tabDailyTracker = [];
    tempdailyTracker = {
        "sliderConcentrationValue": sliderConcentrationValue,
        "sliderMemoryValue": sliderMemoryValue,
        "sliderMoodValue": sliderMoodValue,
        "sliderSleepQualityValue": sliderSleepQualityValue,
        "sliderEnergyValue": sliderEnergyValue,
        "sliderActivitiesValue": sliderActivitiesValue
    };
