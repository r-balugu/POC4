...
function mBaasInitLifeHacks() {
    ...
    konyObject.init("ed32f9432c25d6fe10c2a3647377b6f2", "8d32634a5baba2fc44e4d690cd67884f", " https://100011509.auth.konycloud.com/appconfig", successCallbackLifeHacks, errorCallbackLifeHacks);
}
/**
 * @function
 *
...
function selectLifeHacks() {
    ...
    if (lfhstab.indexOf(selIndex) >= 0) {} else {
    ...
    lfhstab = [];
    lfhstab = lfhs.split(" ");
    lfhstab = lfhstab.sort(function(a, b) {
        return a - b;
    });
